  ...
  return (
    <>
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="text right_text">
                <h2>
                  Pourquoi choisir la publicité en ligne pour promouvoir l'art
                  de la peinture?
                </h2>
                <p className="mt-2">
                  Dans le monde artistique d'aujourd'hui, la publicité en ligne
                  est devenue essentielle pour accroître la visibilité des
                  artistes, promouvoir leurs créations et toucher un public plus
                  large. Avec la montée en puissance d'Internet et l'évolution
                  des comportements en ligne, il est crucial d'adopter une
                ...
                <p className="mt-3">
                  ...
                  aux tendances artistiques émergentes.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-12 mt-5">
              ...
              <p className="mt-2">
                ...
                possibilité de diffuser leurs campagnes publicitaires sur des
                plateformes artistiques de renom, des blogs dédiés aux tendances
                de la peinture contemporaine, ainsi que sur des sites
                spécialisés mettant en avant les dernières innovations
                artistiques.
              </p>
            </div>
            <div className="col-12 mt-5">
      ...
      <section className="discover">
        <div className="container">
          <div className="row align-items-center discover_magazines">
            <div className="col-lg-6">
              <img src={painterTeacher} className="services_img" alt="" />
            </div>
            <div className="col-lg-6">
              <div className="text right_text">
              <h2>
          ...
          <div className="row align-items-center discover_magazines mt-3 reverse">
            ...
            <div className="col-lg-6">
              <img src={vr_img} className="services_img" alt="" />
            </div>
          </div>
        </div>
      </section>
      <section className="advertise">
        <div className="container">
          <div className="text">
            <h2>
              Faites de la publicité avec{" "}
              <span className="ex-font">PaintConnect</span> pour réussir.
            </h2>
            <p className="mt-2">
              Lorsque vous envisagez de lancer une campagne publicitaire avec
              PaintConnect, le coût dépendra de plusieurs facteurs clés liés à
              la portée de votre message publicitaire dans le monde de l'art de
              la peinture.
            </p>
            <p className="mt-2">
      ...
      <section className="chez pt-3 pb-3">
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6 mt-2">
              <img src={chez} className="services_img" alt="" />
            </div>
          </div>
        </div>
      </section>
